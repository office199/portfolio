...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Full-stack developer building scalable web applications with React, Next.js, FastAPI and MySQL." },
      { name: "author", content: "Alex Rivera" },
      { property: "og:title", content: "Alex Rivera — Full-Stack Developer" },
      { property: "og:description", content: "Full-stack developer building scalable web applications." },
